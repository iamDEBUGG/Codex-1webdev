...
export const safetyCountries = [
  {
    ...
    advisories: [
      "Plan for earthquakes and typhoon seasons",
      "Carry translated medical/allergy notes",
    ],
  },
  {
    code: "IN",
    ...
    positives: [
      "Strong hospital access in major cities",
      "Broad rail and domestic flight network",
      "Helpful digital payment coverage",
    ],
    advisories: [
      "Use verified transport at night",
      "Watch air quality and heat alerts by city",
    ],
  },
  {
    code: "FR",
    ...
    positives: [
      ...
      "Dense train and metro coverage",
      "Good emergency response infrastructure",
    ],
    advisories: [
      "Pickpocketing risk in crowded tourist zones",
      "Check strike notices before intercity travel",
    ],
  },
  {
    code: "BR",
    ...
    positives: [
      "Strong private healthcare in major cities",
      "Well-developed tourism areas",
      "Good domestic flight availability",
    ],
    advisories: [
      "Avoid displaying valuables",
      "Use hotel-arranged or app-based transport after dark",
    ],
  },
  {
    code: "ZA",
    ...
    positives: [
      "High-quality private medical care",
      "Well-established guided tourism routes",
      "Clear entry documentation for many travelers",
    ],
    advisories: [
      "Avoid walking alone at night",
      "Use secure transport and confirm local area guidance",
    ],
  },
  {
    code: "US",
    ...
    positives: [
      "Advanced emergency and hospital systems",
      "Strong road and flight connectivity",
      "Reliable travel information availability",
    ],
    advisories: [
  ...
  },
  {
    ...
    positives: [
      ...
      "Clear visitor documentation process",
    ],
    advisories: [
      "Prepare for severe winter conditions",
      "Remote areas need careful route planning",
    ],
  },
  {
    code: "AU",
    ...
    positives: [
      ...
      "Strong travel infrastructure in cities",
    ],
    advisories: [
      "Respect beach and wildlife safety warnings",
      "Distances between cities can be large",
    ],
  },
  {
    code: "AE",
    ...
    positives: [
      ...
      "Modern hospitals and roads",
      "Efficient airports and transit",
    ],
    advisories: [
      "Follow local laws and cultural rules carefully",
      "Plan for extreme heat in summer",
    ],
  },
  {
    code: "TH",
    ...
    positives: [
      "Good private healthcare in tourist hubs",
      "Mature tourism services",
      "Affordable local transport",
    ],
    advisories: [
      "Use helmets and licensed transport",
      "Watch flood and monsoon updates",
    ],
  },
  {
    code: "MX",
    ...
    positives: [
      "Strong tourist infrastructure in major destinations",
      "Good private hospitals in larger cities",
      "Easy regional flight access",
    ],
    advisories: [
      "Review destination-specific advisories",
  ...
  },
  {
    ...
    positives: [
      "Well-traveled major tourist corridors",
      "Good hospital options in large cities",
      "Clear visa/documentation process",
    ],
    advisories: [
      "Use licensed guides and transport",
      "Stay hydrated and plan around heat",
    ],
  },
];
